                ...
                routes={[
                  {
                    ...
                    component: <MainCourse {...this.props} />
                  },
                  { path: '/quan-ly/khoa-hoc/them', component: <AddCourse /> },
                  {
                    path: '/quan-ly/khoa-hoc/chi-tiet/:courseId',
                    component: <DetailCourse {...this.props} />
                  },
                  {
                    path: '/quan-ly/khoa-hoc/cap-nhat/:courseId',
                    component: <UpdateCourse {...this.props} />
                  },
                  {
                    path: '/quan-ly/khoa-hoc/thong-ke/:courseId',
                    component: <StatisticCourse {...this.props} />
                  }
                ]}
              />
            </div>
