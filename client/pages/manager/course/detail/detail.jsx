    ...
    if (this.state.pieChartData.isFetching) {
      api.statisticCourse
        ...
        .then(res => {
          ...
          newNumberAdmins.data.redundant.quantity =
            res.result.object.totalRedundant;
          ...
          newNumberAdmins.isEmpty = newPieChartData.isEmpty =
            res.result.object.isEmpty;
      ...
      <div className="course-details">
        ...
        <React.Fragment>
          <div className="course-details__body">
            {/* <div className="course-details__body__numbers">
                            <NumberAdmin
            ...
            <div className="course-details__body__card">
              ...
              <div className="course-details__body__card__content">
                <div className="course-details__body__card__content__course">
                  <div className="course-details__body__card__content__course__filter">
                    <CustomSelect
            ...
            {/* <div className="course-details__body__card">
                            ...
                            <div className="course-details__body__card__content">
                                <div className="course-details__body__card__content__chart">
                                    <div className="course-details__body__card__content__chart__filter">
                                        <form className="course-details__body__card__content__chart__filter__form">
                                            <input
                                                type="text"
                                                className="course-details__body__card__content__chart__filter__form__input"
                                            ...
                                            <button
                                                type="button"
                                                className="course-details__body__card__content__chart__filter__form__btn course-details__body__card__content__chart__filter__form__btn--primary"
                                            >
                                                thống kê
                                            </button>
                                        </form>
                                    </div>
                                    <div className="course-details__body__card__content__chart__row">
                                        <ColumnChart
                        ...
                        <div className="course-details__body__table">
                            <Table
