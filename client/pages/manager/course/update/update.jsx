...
export class UpdateCourse extends React.Component {
    ...
    componentDidMount() {
        ...
        $('.updateCourse .updateCourse__body').css(
            'margin-top',
            heightOfHeader + 'px'
        );
    }
            ...
            <div className="updateCourse">
                <div className="updateCourse__body">
                    ...
                    <div className="updateCourse__body__card">
                        <div className="updateCourse__body__card__title">
                            Cập nhật khóa học
            </div>
                        <div className="updateCourse__body__card__content">
                            ...
                            >
                                <UpdateCourseInfo
                                    ...
                                    showUpdateCourseBenefitsModal={
                                        this.showUpdateCourseBenefitsModal
                                    }
                        ...
                        <div className="updateCourse__body__card__buttons">
                            {this.state.curPageNumber === 1 ? (
                                <button
                                    disabled
                                    className="updateCourse__body__card__buttons__btn updateCourse__body__card__buttons__btn-previous"
                            ...
                            {this.state.curPageNumber === this.state.pages.length ? (
                                <button
                                    className="updateCourse__body__card__buttons__btn updateCourse__body__card__buttons__btn-next"
