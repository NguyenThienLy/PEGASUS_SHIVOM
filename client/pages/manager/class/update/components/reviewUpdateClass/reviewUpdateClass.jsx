...
import "./reviewUpdateClass.scss";

import { CourseListBenefits, TrainerInfo, ClassTimeItem } from '../../../../../../components'

export class ReviewUpdateClass extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      classTimeItems: [
  ...
  render() {
    return (
      <div className="review-update-class">
        <div className="review-update-class__title">Xác nhận thông tin</div>
        <hr className="divider" />
        <div className="review-update-class__content">
          <div className="review-update-class__content__title">
            <div className="review-update-class__content__title__inner">
              <div>Thông tin lớp học</div>
              <div className="review-update-class__content__title__inner--hover" />
            </div>
          </div>
          <div className="review-update-class__content__info">
            <div className="review-update-class__content__info__item">
              <div className="review-update-class__content__info__item__title">
                Tên lớp học
              </div>
              <div className="review-update-class__content__info__item__content">
            ...
            <div className="review-update-class__content__info__item review-update-class__content__info__item--single">
              <div className="review-update-class__content__info__item__title">
                Giới thiệu ngắn
              </div>
              <div className="review-update-class__content__info__item__content">
