...
import "./updateClassTimeForm.scss";
import TimeKeeper from 'react-timekeeper';
import { TimePickerModal } from '../../../../../../components'

export class UpdateClassTimeForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      weekdays: [
  ...
  submit(e) {
    ...
    $(".update-class-time__form__item__input").val("");
    $(".update-class-time__form__item__select-box__select").val("");
    this.props.handleAddClassTime(body);
  }
  render() {
    return (
      <React.Fragment>
        <form className="update-class-time__form" onSubmit={this.submit}>
          <div className="update-class-time__form__title">thêm lịch biểu</div>
          <div className="update-class-time__form__item">
            <div className="update-class-time__form__item__title">
              Chủ đề
            </div>

            <input
              className="update-class-time__form__item__input"
              type="text"
              name="topic"
              ref="topic"
              required
          ...
          <div className="update-class-time__form__item">
            ...
            <div className="update-class-time__form__item__select-box">
              <select
                required
                className="update-class-time__form__item__select-box__select"
                ref="weekday"
              >
                <option value="" hidden>
                  Chọn thứ
          ...
          <div className="update-class-time__form__item">
            <div className="update-class-time__form__item__title">Giờ bắt đầu</div>
          ...
          <button
            type="submit"
            className="update-class-time__form__btn update-class-time__form__btn--primary"
          >
            thêm
          </button>
        </form>
