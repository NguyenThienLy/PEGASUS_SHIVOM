...
export class MainNews extends React.Component {
  ...
  open(newsId) {
    Router.push(
      `/manager/news/news?newsId=${newsId}`,
      `/quan-ly/tin-tuc/chi-tiet/${newsId}`
    );
  }
    ...
    return (
      <React.Fragment>
        <div className="news-main">
          <div className="news-main__title">Danh sách tin tức</div>
          <div className="news-main__content">
            <div className="news-main__content__filter">
              <div>
            ...
            <div className="base-table__pagination">
              {this.state.newsList ? (
                <Pagination
                  ...
                  total={this.state.newsList.length}
                  limit={10}
                ...
                <Pagination
                  currentPage={this.state.currentPage}
                  total={this.props.news.items.length}
                  limit={10}
                  changePage={this.changePage}
                />
              )}
