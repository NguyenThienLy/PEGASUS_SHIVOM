    ...
    render() {
        return (
            ...
            <div className="media-buttons">
                ...
                <a className="media-buttons__media-icons" href={this.props.social.google} target="_blank">
                ...
                */}
                <a className="media-buttons__media-icons" href={this.props.social.instagram} target="_blank">
                    <i className="fab fa-instagram media-buttons__media-icons--hover"></i>
                </a>
                <a className="media-buttons__media-icons" href={this.props.social.youtube} target="_blank">
