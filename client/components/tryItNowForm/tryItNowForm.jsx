...
export class TryItNowForm extends React.Component {
    ...
    handleInputValidation = (name, value) => {
        _.forEach(this.state.validate.rules, (rule, key) => {
            if (name === key) {
                ...
                else if (rule.regexr && value.length > 0 && !rule.regexr.test(value)) {
    ...
    render() {
        return (
            <React.Fragment>
                <form className="try-it-now__form" id="try-it-now-form" onSubmit={this.submit}>
                    <input
                        type="text"
                    ...
                    />
                    <small>{this.state.form.name.errorMessage}</small>
                    <input
                        type="text"
                        placeholder="Địa chỉ"
                        className="try-it-now__form__input"
                        ...
                        onBlur={this.handleChange}
                    />
                    <small>{this.state.form.address.errorMessage}</small>
                    <input
                        type="email"
                        placeholder="E-mail"
                        className="try-it-now__form__input"
                        ...
                        onBlur={this.handleChange}
                    />
                    <small>{this.state.form.email.errorMessage}</small>
                    <input
                        type="text"
                        ...
                        onBlur={this.handleChange}
                    />
                    <small>{this.state.form.phone.errorMessage}</small>
