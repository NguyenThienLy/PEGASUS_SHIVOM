  ...
  render() {
    return (
      <div className="lineChart">
        <div className="lineChart__title"><span>users overview</span></div>
        <div className="lineChart__select">
          ...
          <div className="lineChart__select__full">
            <button className="lineChart__select__full__btn lineChart__select__full__btn--primary">View full report</button>
          </div>
        </div>
